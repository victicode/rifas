    ...
    <body class="font-sans antialiased  " style="background:#aa13a4; padding-top: 2rem; height: max-content"> 
        <div class=""  style="background:white;height: max-content; padding-top: 1.1rem; width:90%; margin:auto" >
          ...
          <div class=" text-center header__text" style="font-size:1.3rem; font-weight:bold; padding-bottom:1rem; height: 12%; color:#000; text-align:center; margin-top:1rem"> 
            <b class="principal__text" style="letter-spacing:2px; color:#aa13a4;">
          ...
          <div class="content-email-body" style="width:100%; margin:auto ; padding-bottom:5rem; text-align:center">
            ...
            <div class="sectionOfEmail" style="width:90%; margin:auto ; margin-top:2rem">
              <div style="flex-wrap:wrap; display:flex; width:100%; margin-top:1.5rem;" >
                ...
                <div style="font-size:0.95rem; font-weight:bold; width:33%; text-align:center;text-align:center;" class="client__data">
                  Documento: {{ $order->client->ci }}
                </div>
                <div style="font-size:0.95rem; font-weight:bold; width:33%; text-align:center;text-align:end;" class="client__data">
                  N° de compra: #{{ $order->number }}
                </div>
              </div>
            </div>
            <div class="sectionOfEmail" style="width:90%; margin:auto ; margin-top:2rem">
              <table style="width:100%">
                <thead class="tablePayViewHead">
                    <tr>
                      <th class="th__rifa" style="font-size:1rem; color:black;border-bottom: 1px solid darkgray; text-align:start " >
                        Rifa
                      </th>
                      <th class="th__rifa" style="font-size:1rem; color:black;border-bottom: 1px solid darkgray; text-align:start " >
                        Precio
                      </th>
                      <th class="th__rifa" style="font-size:1rem; color:black;border-bottom: 1px solid darkgray; text-align:center " >
                        Tickets
                      </th>
                      <th class="th__rifa" style="font-size:1rem; color:black;border-bottom: 1px solid darkgray; text-align:end " >
                        Total
                      </th>
                    </tr>
                </thead>
                <tbody> 
                  <tr style="">
                    <td class="td__rifa" style="font-size:1rem; color:black; padding:0.5rem 0rem; border-bottom: 1px solid darkgray; font-weight:600;text-align:start ">
                     [{{ $order->rifa->title }}]
                    </td>
                    <td class="td__rifa" style="font-size:1rem; color:black; padding:0.5rem 0rem; border-bottom: 1px solid darkgray; font-weight:600;text-align:start ">
                      {{ $order->methodPay->coin->symbol }}  {{ number_format($order->rifa->configuration->price, 0, ",", ".") }}
                    </td>
                    <td class="td__rifa" style="font-size:1rem; color:black; padding:0.5rem 0rem; border-bottom: 1px solid darkgray; font-weight:600;text-align:center ">
                      x{{number_format($order->quantity, 0, ",", ".") }}
                    </td>
                    <td class="td__rifa" style="font-size:1rem; color:black; padding:0.5rem 0rem; border-bottom: 1px solid darkgray; font-weight:600;text-align:end ">
                      {{ $order->methodPay->coin->symbol }} {{number_format($order->amount, 0, ",", ".") }}
                    </td>
                  </tr>
            ...
            <div class="sectionOfEmail" style="width:90%; margin:auto ; margin-top:2rem">
              <div style="">
                <div class="text__date-rifa" style=" font-weight:600; border: 1px solid darkgrey; padding:0.5rem 4rem; border-radius:0.8rem; font-size:1.1rem; width:max-content; margin:auto; margin-top:1rem; text-align:center">
                  ...
                  {{ date("d/m/Y", strtotime($order->rifa->due_date)) }} 📆
                </div>
              </div>
            </div>
            <div class="sectionOfEmail" style="width:90%; margin:auto ; margin-top:2rem">
