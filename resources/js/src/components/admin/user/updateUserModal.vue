        ...
        >
          ...
          <section>
            <div class="flex justify-evenly mt-5">
              ...
              <q-btn label="Actualizar"   color="blur" type="submit" style="width: 50%; border-radius: 0.8rem; padding: 0.7rem 0px;" :loading="loading"/>
            </div>
          </section>
        </q-form>
      </q-card>
