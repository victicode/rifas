...
<template>
  <div class="md:px-8 px-5 pb-5" style="">
    <div v-if="loading">
      ...
      <template v-else>
        <div class="text-h6 text-black text-center mt-10 mb-24" style="height: 52vh;">
    ...
    <div v-else class="flex justify-center mt-10 mb-24" style="height: 52vh;">
      <q-spinner-tail
        color="primary"
        class="mt-24 "
        size="5rem"
